...
excel = RESULT_DIR / 'new_shap_data.xlsx'
...
plt.savefig(RESULT_DIR / "new_shap_summary_plot.png", dpi=300, bbox_inches='tight')
...
plt.savefig(RESULT_DIR / 'shap_all.png', dpi=300, bbox_inches='tight')
