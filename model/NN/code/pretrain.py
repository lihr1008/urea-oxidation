...
torch.save(premodel.state_dict(), '../results/PBA-ml-pretrain_model.pkl')
state_dict = premodel.state_dict()
torch.save(state_dict, '../results/PBA-ml-pretrain_model_weights.pth')
...
with pd.ExcelWriter(f'../results/pretrain_result_all.xlsx') as writer:
