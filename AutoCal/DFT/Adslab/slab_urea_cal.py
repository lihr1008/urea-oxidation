...
# 读取POSCAR_urea文件
with open('slab_urea_temp.cif', 'r') as file:
    content = file.read()
...
for i in range(len(metals)):
    ...
    with open(f'cal/slab_urea_{metals[i][0]}_{metals[i][1]}_{metals[i][2]}_{metals[i][3]}_{metals[i][4]}_{metals[i][5]}.cif', 'w') as file:
        file.write(modified_content)


    parser = CifParser(f'cal/slab_urea_{metals[i][0]}_{metals[i][1]}_{metals[i][2]}_{metals[i][3]}_{metals[i][4]}_{metals[i][5]}.cif')
