...
PROBEX_API_KEY = os.getenv("PROBEX_API_KEY", "")
...
config.set_provider_config("llm", "OpenAI", {
    ...
    "api_key": PROBEX_API_KEY      # 👈 使用您有效的密钥
})
...
def get_default_parameters():
    ...
    params = {
        'try_count': 11,  # 25,57,93,16,42,131,197,107
    }
    return params
...
# 将结果输出到txt文件
with open(f"qwen_result/converg/{config2['try_count']}_30.txt", "w", encoding="utf-8") as f:
    f.write(str(result))
