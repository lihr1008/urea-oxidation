...
from mol_filter.uo_mol_filter import UOMolFilter
...
class UOMolsCount:
    ...
    def filter(cls, unique_mols_fp: str, filter_mols_fp: str):
        ...
        mols_table = UOMolFilter.filter(mols_table)
...
if __name__ == "__main__":
    mfp = '../data/wos_urea_oxidation_mols/mol_table.tsv'
    umfp = '../data/wos_urea_oxidation_mols/unique_mol_table.tsv'
    fmfp = '../data/wos_urea_oxidation_mols/filter_mol_table.tsv'
    UOMolsCount.filter(umfp, fmfp)
    UOMolsCount.count(fmfp)
